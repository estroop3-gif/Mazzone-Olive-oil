...
interface WholesaleTopBarProps {
  onMenuClick: () => void;
}

const BREADCRUMB_MAP: Record<string, string> = {
  "/portal/wholesale": "Dashboard",
  "/portal/wholesale/catalog": "Catalog & Pricing",
  "/portal/wholesale/orders": "Orders",
  "/portal/wholesale/new-order": "New Order",
  "/portal/wholesale/profile": "Company Profile",
  "/portal/wholesale/support": "Support",
};

export function WholesaleTopBar({ onMenuClick }: WholesaleTopBarProps) {
